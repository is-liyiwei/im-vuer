...
<script>
  ...
  export default {
      ...
      initEvent() {
        ...
        draggable(el, {
          ...
          drag: (touch, $event) => {
            ...
            if(this.distance > 100 && typeof this.pullDownMethods == 'function') {
            ...
            } else if(this.distance < -100 && typeof this.pullUpMethods == 'function') {
    ...
    computed: {
      topBlock () {
        let tsY = this.distance > 0 ? this.distance / 2 : -80;
        return {
          marginTop: tsY + 'px'
        }
      },
